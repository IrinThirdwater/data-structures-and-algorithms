...
class SortTest {
    ...
    /**
     * ArrayCase describe different test cases to be tested on sorting methods.
     */
    private enum ArrayCase {
        ...
        // ArrayCase Constructor
        ArrayCase (String name, int[] sortedArray, int[] testArray) {
            this.name = name;
    ...
    void insertionSort (ArrayCase testCase) {
        assertArrayEquals(
    ...
    @ParameterizedTest
    @EnumSource(ArrayCase.class)
    void selectionSort (ArrayCase testCase) {
        assertArrayEquals(
            testCase.expectedArray(),
